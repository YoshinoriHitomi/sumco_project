...
Public Function funGet_TBCME020(tHIN As tFullHinban, tGetRec As type_DBDRV_scmzc_fcmkc001c_Siyou) As FUNCTION_RETURN
    ...
    'Add Start 2012/06/04 SMPK H.Ohkubo
    sql = sql & ",HSXCOSF3PK "
    'Add End 2012/06/04 SMPK H.Ohkubo
...
'        If Not IsNull(rs("HSXBMD3MBP")) Then .HSXBMD3MBP = rs("HSXBMD3MBP")     ' 品ＳＸＢＭＤ３面内分布
        ...
        If Not IsNull(rs("HSXCOSF3PK")) Then .HSXCOSF3PK = rs("HSXCOSF3PK")   ' 品ＳＸＣＯＳＦ３パターン区分
...
'' 2008/10/01 L/DL,OSF判定ﾛｼﾞｯｸ追加 ADD By Systech End
    ...
    sql = sql & ",HSXCJLTBND "
    'Add End   2011/02/01 SMPK Miyata
    sql = sql & ",LTCONVAL "        '2011/07/25 LT10Ω判定追加対応
...
'' 2008/10/01 L/DL,OSF判定ﾛｼﾞｯｸ追加 ADD By Systech End
        ...
        'Add End   2011/02/01 SMPK Miyata
        .HSXLT10MIN = fncNullCheck(rs("LTCONVAL"))      ' 品SXL10Ω下限 2011/07/28
