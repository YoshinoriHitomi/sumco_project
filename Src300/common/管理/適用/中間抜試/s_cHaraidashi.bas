...
'Add Start 2011/04/12 SMPK Miyata
    MSMPFLGWFR      As String * 1   ' 中間抜試フラグ/WF/比抵抗　[Rs]
    MSMPFLGWFO      As String * 1   ' 中間抜試フラグ/WF/酸素　[Oi]
    MSMPFLGWFOF     As String * 1   ' 中間抜試フラグ/WF/OSF　[O1-O3]
    MSMPFLGWFBM     As String * 1   ' 中間抜試フラグ/WF/BMD　[B1-B3]
    MSMPFLGWFGD     As String * 1   ' 中間抜試フラグ/WF/GD　[GD]
    MSMPFLGWFDOI    As String * 1   ' 中間抜試フラグ/WF/Δoi（酸素析出）[DOI1-DOI3]
    MSMPFLGWFAOI    As String * 1   ' 中間抜試フラグ/WF/AOI（残存酸素）[AO]
    MSMPFLGWFDS     As String * 1   ' 中間抜試フラグ/WF/DSOD  [DS]
    MSMPFLGWFDZ     As String * 1   ' 中間抜試フラグ/WF/DZ　　[DZ]
    MSMPFLGWFOT1    As String * 1   ' 中間抜試フラグ/WF/その他1  [OT1]
    MSMPWFOT1MAI    As String * 1   ' 中間抜試フラグ/WF/その他1　枚数
    MSMPWFOT1TIM    As String       ' 中間抜試フラグ/WF/その他1　期限
    MSMPFLGEPOF     As String * 1   ' 中間抜試フラグ/EP/OSF [O1E-O3E]
    MSMPFLGEPBM     As String * 1   ' 中間抜試フラグ/EP/BMD [B1E-B3E]
    MSMPFLGEPOT2    As String * 1   ' 中間抜試フラグ/EP/その他2  [OT2]
    MSMPWFOT2MAI    As String * 1   ' 中間抜試フラグ/EP/その他2　枚数
    MSMPWFOT2TIM    As String       ' 中間抜試フラグ/WF/その他2　期限
    MSMPTANI        As Integer      ' 中間抜試単位 (mm)
