...
Public Type type_DBDRV_scmzc_fcmkc001c_OSF
    ...
    COSF3PTNJSK As String * 1           ' ﾊﾟﾀｰﾝ区分実績
...
'    CJBUIUMU        As String * 1       ' CJ 部位別判定有無
    ...
    CJALLMINDIC5    As Integer          ' CJ 共通Disk半径下限値         2012/05/22 SMPK H.Ohkubo CLESTA評価レベル判定対応
...
'            If GetCOSF3ID(strJDGEIDC, Trim(sCryNum)) <> FUNCTION_RETURN_SUCCESS Then
            If GetJDGEID("", 0, tFullHin, "", Trim(sCryNum), strJDGEIDC) <> FUNCTION_RETURN_SUCCESS Then
            ...
            Else
                ...
                Else
                    ...
                    If strOSFRD1 = "R" And strOSFRD2 = "-" Then
                        ...
                        If GetCOSF3PTN(strJDGEIDC, lSmpPos, strOSFRD1, strOSFRD2, strRMAXC5, strDMAXC5, strDRRMAXC5, strDRDMAXC5, strDMINC5, strDRDMINC5) <> FUNCTION_RETURN_SUCCESS Then
                    ...
                    ElseIf strOSFRD1 = "D" Then
                        ...
                        Else
                            ...
                            lDMINC5 = Trim(strDMINC5)
                            
                            '実績値の判定
                            If (lngOSFWID1 >= lDMINC5) And (lngOSFWID1 <= lDMaxc5) Then
                                '反映OK
                                retJudg = True
                            ElseIf (lngOSFWID1 < lDMINC5) Or (lngOSFWID1 > lDMaxc5) Then
                                '反映NG
                                retJudg = False
                            End If
                        End If
...
'                        If Trim(strDRRMAXC5) = "" Or Trim(strDRDMAXC5) = "" Or Trim(strDRMINC5) = "" Then
                        'Add Start 2012/06/29  Y.Hitomi
                            retJudg = False
                            GoTo ChkSxlHaneiNG
                        Else
                            ...
                            lDRDMINC5 = Trim(strDRDMINC5)
                            
                            '実績値の判定
                            If lngOSFWID1 <= lDrrMaxc5 And lngOSFWID2 >= lDRDMINC5 And lngOSFWID2 <= lDrdMaxc5 Then
                                '反映OK
                                retJudg = True
                            ElseIf lngOSFWID1 > lDrrMaxc5 Or lngOSFWID2 < lDRDMINC5 Or lngOSFWID2 > lDrdMaxc5 Then
                                '反映NG
                                retJudg = False
                            End If
                        End If
                    ...
                    tCOSF3P.HSXCOSF3PK = tSiyou.HSXCOSF3PK
                    tCOSF3P.COSF3PTNJSK = tCryOSF.COSF3PTNJSK
...
'    sql = sql & "CJPICALC , CJHANTEI, CJDMAXPIC5, CJRMAXPIC5, CJDRMAXPIC5, CJALLMAXDIC5, CJALLMINRINC5, CJALLMAXRIGC5, "
    sql = sql & "CJPICALC , CJHANTEI, CJDMAXPIC5, CJRMAXPIC5, CJDRMAXPIC5, CJALLMINDIC5, CJALLMAXDIC5, CJALLMINRINC5, CJALLMAXRIGC5, "
...
'Add Start 2012/05/22 SMPK H.Ohkubo CLESTA評価レベル判定対応
        If IsNull(rs("CJALLMINDIC5")) = False Then .CJALLMINDIC5 = rs("CJALLMINDIC5")       ' CJ 共通Disk半径下限値
