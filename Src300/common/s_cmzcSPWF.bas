...
'                    GetWFSamp = "4"
            ...
            'Add Start 2012/03/01 Y.Hitomi エッジ補正対応
            If GetWFSamp = "3" Then
                liRet = funCodeDBGetMatrixReturn("SB", "EG", CStr(tblSampDN.HWFRSPOH), CStr(tblSampUP.HWFRSPOH))
                If liRet = -1 Then
                ElseIf liRet = 0 Then
                    GetWFSamp = "4"
                End If
            End If
            'Add End 2012/03/01 Y.Hitomi エッジ補正対応
