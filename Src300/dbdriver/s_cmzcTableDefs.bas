...
''Add Start 2011/07/25 LT10Ω判定追加対応 T.Koi(SETsw)
    SXLLT_CONVAL   As Integer       ' SXLLT10Ω_計算結果
...
''Add Start 2011/07/25 LT10Ω判定追加対応 T.Koi(SETsw)
    HSXLT10MIN As Integer           ' 品ＳＸＬLT10下限
''Add End   2011/07/25 LT10Ω判定追加対応 T.Koi(SETsw)
...
'' 2008/10/01 L/DL,OSF判定ﾛｼﾞｯｸ追加 ADD By Systech End
    ...
    'Add Start 2012/05/30 SMPK H.Ohkubo CLESTA評価レベル判定対応
    HSXCOSF3PK As String * 1        '品ＳＸＣＯＳＦ３パターン区分
    'Add End   2012/05/30 SMPK H.Ohkubo CLESTA評価レベル判定対応
...
'    MESDATA15 As String * 10        ' 測定データその1５
    MESDATA1 As String          ' 測定データその１
    MESDATA2 As String          ' 測定データその２
    MESDATA3 As String          ' 測定データその３
    MESDATA4 As String          ' 測定データその４
    MESDATA5 As String          ' 測定データその５
    MESDATA6 As String          ' 測定データその６
    MESDATA7 As String          ' 測定データその７
    MESDATA8 As String          ' 測定データその８
    MESDATA9 As String          ' 測定データその９
    MESDATA10 As String         ' 測定データその１０
    MESDATA11 As String         ' 測定データその1１
    MESDATA12 As String         ' 測定データその1２
    MESDATA13 As String         ' 測定データその1３
    MESDATA14 As String         ' 測定データその1４
    MESDATA15 As String         ' 測定データその1５
...
''Add Start 2011/07/14 LT10Ω判定追加対応 T.Koi(SETsw)
    'CRYREST10CS As String * 1       '実績FLG(T10)      'null(\0)文字でのSQLエラー回避 可変長に 2011/08/10 SETsw kubota
    CRYREST10CS     As String       '実績FLG(T10)
''Add End   2011/07/14 LT10Ω判定追加対応 T.Koi(SETsw)

'Add Start 2012/05/16 SMPK H.Ohkubo CLESTA評価レベル判定対応
    JDGEIDCS        As String       '判定ID
'Add End 2012/05/16 SMPK H.Ohkubo CLESTA評価レベル判定対応
End Type
...
'' 2008/10/01 L/DL,OSF判定ﾛｼﾞｯｸ追加 ADD By Systech End
'Add Start 2012/05/30 SMPK H.Ohkubo CLESTA評価レベル判定対応
    COSF3PTNJSK As String * 1       ' パターン区分実績
'Add End 2012/05/30 SMPK H.Ohkubo CLESTA評価レベル判定対応
End Type
