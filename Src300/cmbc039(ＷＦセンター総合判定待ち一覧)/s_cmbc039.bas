            ...
            If (udtInf(1).Doi(0).HWFOSxHS = "H") Or (udtInf(1).Doi(0).HWFOSxHS = "S") Then
                ...
                If udtInf(0).Doi(0).HWFOSxNS <> udtInf(1).Doi(0).HWFOSxNS Or _
                   ...
                   udtInf(0).Doi(0).HWFOSxST <> udtInf(1).Doi(0).HWFOSxST Then
                    lblMsg.Caption = GetMsgStr("EHINC", Trim(udtHin(1).hinban) & " " & " ⊿Oi1")
                    Exit Function
                End If
            End If
        Else
            ...
            If (udtInf(1).Doi(0).HWFOSxHS = "H") Or (udtInf(1).Doi(0).HWFOSxHS = "S") Then
                '検査有り
                lblMsg.Caption = GetMsgStr("EHINC", Trim(udtHin(1).hinban) & " " & " ⊿Oi1実績無")
                Exit Function
            End If
        End If
        If (tblTotal.typ_Param.WFSMP(c0).WFRESDO2CW = "1") Then
            ...
            If (udtInf(1).Doi(1).HWFOSxHS = "H") Or (udtInf(1).Doi(1).HWFOSxHS = "S") Then
                ...
                If udtInf(0).Doi(0).HWFOSxNS <> udtInf(1).Doi(0).HWFOSxNS Or _
                   ...
                   udtInf(0).Doi(0).HWFOSxSI <> udtInf(1).Doi(0).HWFOSxSI Or _
                   udtInf(0).Doi(0).HWFOSxST <> udtInf(1).Doi(0).HWFOSxST Then
                    lblMsg.Caption = GetMsgStr("EHINC", Trim(udtHin(1).hinban) & " " & " ⊿Oi2")
                    Exit Function
                End If
            End If
        Else
            ...
            If (udtInf(1).Doi(1).HWFOSxHS = "H") Or (udtInf(1).Doi(1).HWFOSxHS = "S") Then
                '検査有り
                lblMsg.Caption = GetMsgStr("EHINC", Trim(udtHin(1).hinban) & " " & " ⊿Oi2実績無")
                Exit Function
            End If
        End If
        If (tblTotal.typ_Param.WFSMP(c0).WFRESDO3CW = "1") Then
            ...
            If (udtInf(1).Doi(2).HWFOSxHS = "H") Or (udtInf(1).Doi(2).HWFOSxHS = "S") Then
                ...
                If udtInf(0).Doi(0).HWFOSxNS <> udtInf(1).Doi(0).HWFOSxNS Or _
                   ...
                   udtInf(0).Doi(0).HWFOSxSI <> udtInf(1).Doi(0).HWFOSxSI Or _
                   udtInf(0).Doi(0).HWFOSxST <> udtInf(1).Doi(0).HWFOSxST Then
                    lblMsg.Caption = GetMsgStr("EHINC", Trim(udtHin(1).hinban) & " " & " ⊿Oi3")
                    Exit Function
                End If
            End If
        Else
            ...
            If (udtInf(1).Doi(2).HWFOSxHS = "H") Or (udtInf(1).Doi(2).HWFOSxHS = "S") Then
                '検査有り
                lblMsg.Caption = GetMsgStr("EHINC", Trim(udtHin(1).hinban) & " " & " ⊿Oi3実績無")
                Exit Function
            End If
        End If
    Next
