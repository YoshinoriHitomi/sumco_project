 ...
 *
 ***********************************************************/
public class CZCMSHeaterTemp extends JDialog {

    public final float    TIMES     = 0.1f ;
    private DecimalFormat format    = new DecimalFormat("0.0");

    private final int SEND_MAX      =  500;
    private final int SEND_MIN      = -500;
    ...
    private final int PV_RESULT     = 14;
    private final int PV_PROFAIL    = 66;
    private final int PV_MANNUAL    = 100;
    ...
    CZCMSHeaterTemp(){
        ...
        man_val = new JLabel("0.0 度",JLabel.CENTER);
        ...
        pro_label = new JLabel("0.0 度",JLabel.CENTER);
        ...
        pro_slider = new JSlider(JSlider.VERTICAL,-2000,2000,0);
        pro_slider.setBounds(20, 68, 100, 300);
        pro_slider.setBorder(new Flush3DBorder());
        pro_slider.setMajorTickSpacing(250);
        pro_slider.setMinorTickSpacing(50);
        ...
        pro_slider.getLabelTable().put(new Integer(2000),label);

        label = new JLabel(" 175.0", JLabel.CENTER );   
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(1750),label);

        label = new JLabel(" 150.0", JLabel.CENTER );   
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(1500),label);

        label = new JLabel(" 125.0", JLabel.CENTER );   
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(1250),label);

        label = new JLabel(" 100.0", JLabel.CENTER );   
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(1000),label);

        label = new JLabel("  75.0", JLabel.CENTER );   
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(750),label);

        label = new JLabel("  50.0", JLabel.CENTER );   
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(500),label);

        label = new JLabel("  25.0", JLabel.CENTER );   
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(250),label);
        ...
        results_label = new JLabel("0.0 度",JLabel.CENTER);
        ...
        results_slider = new JSlider(JSlider.VERTICAL,0,20000,0);
        ...
        label = new JLabel(" 1750.0", JLabel.CENTER );  
        label.setForeground(java.awt.Color.red);
        results_slider.getLabelTable().put(new Integer(17500),label);
        ...
        label = new JLabel(" 1250.0", JLabel.CENTER );  
        label.setForeground(java.awt.Color.blue);
        results_slider.getLabelTable().put(new Integer(12500),label);

        label = new JLabel(" 1000.0", JLabel.CENTER );  
        label.setForeground(java.awt.Color.blue);
        results_slider.getLabelTable().put(new Integer(10000),label);

        label = new JLabel("  750.0", JLabel.CENTER );  
        label.setForeground(java.awt.Color.blue);
        ...
        instruct_label = new JButton("0.0 度");
        ...
        instruct_slider.setMajorTickSpacing(50);
        instruct_slider.setMinorTickSpacing(10);
        ...
        label = new JLabel(" 45.0", JLabel.CENTER );    
        label.setForeground(java.awt.Color.red);
        instruct_slider.getLabelTable().put(new Integer(450),label);

        label = new JLabel(" 40.0", JLabel.CENTER );    
        label.setForeground(java.awt.Color.red);
        instruct_slider.getLabelTable().put(new Integer(400),label);

        label = new JLabel(" 35.0", JLabel.CENTER );    
        label.setForeground(java.awt.Color.red);
        instruct_slider.getLabelTable().put(new Integer(350),label);

        label = new JLabel(" 30.0", JLabel.CENTER );    
        label.setForeground(java.awt.Color.red);
        instruct_slider.getLabelTable().put(new Integer(300),label);

        label = new JLabel(" 25.0", JLabel.CENTER );    
        label.setForeground(java.awt.Color.red);
        instruct_slider.getLabelTable().put(new Integer(250),label);

        label = new JLabel(" 20.0", JLabel.CENTER );    
        label.setForeground(java.awt.Color.red);
        instruct_slider.getLabelTable().put(new Integer(200),label);

        label = new JLabel(" 15.0", JLabel.CENTER );    
        label.setForeground(java.awt.Color.red);
        instruct_slider.getLabelTable().put(new Integer(150),label);

        label = new JLabel(" 10.0", JLabel.CENTER );    
        label.setForeground(java.awt.Color.red);
        instruct_slider.getLabelTable().put(new Integer(100),label);

        label = new JLabel("  5.0", JLabel.CENTER );    
        label.setForeground(java.awt.Color.red);
        instruct_slider.getLabelTable().put(new Integer(50),label);
        ...
        /////////////////////////////////////
        up100 = new JButton("↑");
        up100.setBounds(240, 368, 50, 24);
        up100.setLocale(new Locale("ja","JP"));
        up100.setFont(new java.awt.Font("dialog", 0, 22));
        ...
        up10 = new JButton("↑");
        up10.setBounds(290, 368, 50, 24);
        up10.setLocale(new Locale("ja","JP"));
        up10.setFont(new java.awt.Font("dialog", 0, 18));
        ...
        down100 = new JButton("↓");
        down100.setBounds(240, 392, 50, 24);
        down100.setLocale(new Locale("ja","JP"));
        down100.setFont(new java.awt.Font("dialog", 0, 22));
        ...
        down10 = new JButton("↓");
        down10.setBounds(290, 392, 50, 24);
        down10.setLocale(new Locale("ja","JP"));
        down10.setFont(new java.awt.Font("dialog", 0, 18));
    ...
    public boolean setDefault(){
        CZSystem.log("CZCMSHeaterTemp","setDefault()");
    ...
    class SendButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            ...
            setSendStatus();
            CZSystem.log("CZCMSHeaterTemp","SendButton ----->[" + send_status + "]");
            if(send_status == 0) return;
            //Send
            CZSystem.CZOperateMainHeaterTemp(send_status);
        }
    }
    ...
    */
    class SendUndo implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSHeaterTemp","SendSendUndo");
            //Send
            CZSystem.CZOperateUndoMainHeaterTemp(send_status);
            setDefault();
        }
    }
    ...
    */
    class ZeroButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSHeaterTemp","ZeroSendUndo");
            setDefault();
        }
    }
    ...
    */
    class ProEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            CZSystem.log("CZCMSHeaterTemp","Proc Change[" + val + "]");
            pro_label.setText(format.format(data) + " 度");
        }
    }
    ...
    */
    class ResultsEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSHeaterTemp","Results Change[" + val + "]");
            results_label.setText(format.format(data) + " 度");
        }
    }
    ...
    */
    class InstructEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            int val = instruct_slider.getValue();
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSHeaterTemp","Instruct Change[" + val + "]");
            ...
            instruct_label.setText(format.format(data) + " 度");
        }
    }
    ...
    */
    class UpdateThread extends Thread {
        ...
        public void run(){
            ...
            CZSystem.log("CZCMSHeaterTemp","UpdateThread START");
        ...
        private void setData(){
            ...
            man_val.setText(format.format(man) + " 度");

            CZSystem.log("CZCMSHeaterTemp","" + format.format(prof) + " C");
            CZSystem.log("CZCMSHeaterTemp","" + format.format(reslt) + " C");
            CZSystem.log("CZCMSHeaterTemp","" + format.format(man) + " C");
        }
    }
}
