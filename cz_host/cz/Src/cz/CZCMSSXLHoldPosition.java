...
/***********************************************************
 *
 *   集中監視－結晶保持位置変更用Window 
 * @author  (KPK Co.,Ltd.)
 * @version 1.0 (2003/04/01)
 *
 ***********************************************************/
public class CZCMSSXLHoldPosition extends JDialog {
    ...
    private final int    PV_RESULT      = 113;

    // ---------- コンストラクタ ---------------------------
    //
	@SuppressWarnings("unchecked")
    CZCMSSXLHoldPosition(){
        super();
    ...
    public boolean setDefault(){
        CZSystem.log("CZCMSSXLHoldPosition","setDefault()");
    ...
    class SendButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            ...
            CZSystem.log("CZCMSSXLHoldPosition","SendButton ----->[" + send_status + "]");
            if(send_status == 0) return;
            //Send
            CZSystem.CZOperateHojiguPosition(send_status,interlock.isSelected());
            interlock.setSelected(false);
        }
    }
    ...
    class SendUndo implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSSXLHoldPosition","SendSendUndo");
            //Send
            CZSystem.CZOperateUndoHojiguPosition(send_status,true);
            setDefault();
        }
    }
    ...
    class UpZeroButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSSXLHoldPosition","UpZeroSendUndo");
            up_slider.setValue(0);
        }
    }
    ...
    class DownZeroButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSSXLHoldPosition","DownZeroSendUndo");
            down_slider.setValue(0);
        }
    }
    ...
    class ResultsEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            CZSystem.log("CZCMSSXLHoldPosition","Results Change[" + val + "]");
    ...
    class UpEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSSXLHoldPosition","Instruct Change[" + val + "]");
    ...
    class UpdateThread extends Thread {
        ...
        public void run(){
            ...
            CZSystem.log("CZCMSSXLHoldPosition","UpdateThread START");
        ...
        private void setData(){
            ...
            CZSystem.log("CZCMSSXLHoldPosition","" + format.format(reslt) + " mm");
        }
    }
}
