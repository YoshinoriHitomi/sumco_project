 ...
 *
 ***********************************************************/
public class CZCMSHeater2Power extends JDialog {
    ...
    private final int PV_RESULT     = 12;
    private final int PV_PROFAIL    = 61;
    private final int PV_MANNUAL    = 98;
    ...
    public boolean setDefault(){
        CZSystem.log("CZCMSHeater2Power","setDefault()");
    ...
    class SendButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            ...
            setSendStatus();
            CZSystem.log("CZCMSHeater2Power","SendButton ----->[" + send_status + "]");
            if(send_status == 0) return;
            //Send
            CZSystem.CZOperateMainHeater2Power(send_status);
        }
    }
    ...
    class SendUndo implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSHeater2Power","SendSendUndo");
            //Send
            CZSystem.CZOperateUndoMainHeater2Power(send_status);
            setDefault();
        }
    }
    ...
    class ZeroButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSHeater2Power","ZeroSendUndo");
            setDefault();
        }
    }
    ...
    class ProEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            CZSystem.log("CZCMSHeater2Power","Proc Change[" + val + "]");
    ...
    class ResultsEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSHeater2Power","Results Change[" + val + "]");
    ...
    class InstructEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            int val = instruct_slider.getValue();
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSHeater2Power","Instruct Change[" + val + "]");
    ...
    class UpdateThread extends Thread {
        ...
        public void run(){
            ...
            CZSystem.log("CZCMSHeater2Power","UpdateThread START");
        ...
        private void setData(){
            ...
            CZSystem.log("CZCMSHeater2Power","" + format.format(prof) + " Kw");
            CZSystem.log("CZCMSHeater2Power","" + format.format(reslt) + " Kw");
            CZSystem.log("CZCMSHeater2Power","" + format.format(man) + " Kw");
        }
    }
}
