 ...
 ***********************************************************/
public class CZRoSelectWin4 extends JDialog {
...
// chg end 2008.09.16
		...
		String roN = CZFpAveMain.main_ro_name_lab.getText();
...
// add start 2008.09.16
			CZFpAveMain.conpane.clearBtCondition();
			CZFpAveMain.main_ro_name_lab.setText(ro_sel_Pad[ro_index].getText());
			setVisible(false);
// add end 2008.09.16
		}
	}
