 ...
 *
 ***********************************************************/
public class CZCMSArTop extends JDialog {
    ...
    private final int   PV_RESULT   = 16;
    private final int   PV_PROFAIL  = 73;
    private final int   PV_MANNUAL  = 102;
...
//@@        CZSystem.log("CZCMSArTop","setDefault()");
    ...
    class SendButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            ...
            setSendStatus();
//@@            CZSystem.log("CZCMSArTop","SendButton ----->[" + send_status + "]");
            if(send_status == 0) return;
            //Send
            CZSystem.CZOperateTopArgonFlow(send_status);
        }
    }
    ...
    class SendUndo implements ActionListener {
        public void actionPerformed(ActionEvent ev){
//@@            CZSystem.log("CZCMSArTop","SendSendUndo");
            //Send
            CZSystem.CZOperateUndoTopArgonFlow(send_status);
            setDefault();
        }
    }
    ...
    class ZeroButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
//@@            CZSystem.log("CZCMSArTop","ZeroSendUndo");
            setDefault();
        }
    }
...
//@@            CZSystem.log("CZCMSArTop","ProEvent Proc Change[" + val + "]");
    ...
    class ResultsEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            float data = (float)val * TIMES;
//@@            CZSystem.log("CZCMSArTop","Results Change[" + val + "]");
    ...
    class InstructEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            int val = instruct_slider.getValue();
            float data = (float)val * TIMES;
//@@            CZSystem.log("CZCMSArTop","Instruct Change[" + val + "]");
...
//@@            CZSystem.log("CZCMSArTop","UpdateThread START");
        ...
        private void setData(){
            ...
            man_val.setText(format.format(man) + " L/min");

//@@            CZSystem.log("CZCMSArTop","" + format.format(prof)  + " L/min");
//@@            CZSystem.log("CZCMSArTop","" + format.format(reslt) + " L/min");
//@@            CZSystem.log("CZCMSArTop","" + format.format(man)   + " L/min");
        }
    }
}
