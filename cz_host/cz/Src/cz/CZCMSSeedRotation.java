 ...
 *
 ***********************************************************/
public class CZCMSSeedRotation extends JDialog {
    ...
    private final int PV_RESULT         = 18;
    private final int PV_PROFAIL        = 80;
    private final int PV_MANNUAL        = 94;
    ...
    CZCMSSeedRotation(){
        ...
        man_val = new JLabel("0.000 rpm",JLabel.CENTER);
    ...
    public boolean setDefault(){
        CZSystem.log("CZCMSSeedRotation","setDefault()");
    ...
    class SendButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            setSendStatus();
            CZSystem.log("CZCMSSeedRotation","SendButton ----->[" + send_status + "]");
            if(send_status == 0) return;
            //Send
            CZSystem.CZOperateSeedRotate(send_status);
            setDefault();   
        }
    }
    ...
    class SendUndo implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSSeedRotation","SendSendUndo");
            //Send
            CZSystem.CZOperateUndoSeedRotate(send_status);
            setDefault();
        }
    }
    ...
    class ZeroButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSSeedRotation","ZeroSendUndo");
            setDefault();
        }
    }
    ...
    class ProEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            CZSystem.log("CZCMSSeedRotation","Proc Change[" + val + "]");
    ...
    class ResultsEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSSeedRotation","Results Change[" + val + "]");
    ...
    class InstructEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            int val = instruct_slider.getValue();
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSSeedRotation","Instruct Change[" + val + "]");
    ...
    class UpdateThread extends Thread {
        ...
        public void run(){
            ...
            CZSystem.log("CZCMSSeedRotation","UpdateThread START");
        ...
        private void setData(){
            ...
            setTitle(s + " : シード回転");
//            setTitle(CZSystem.getRoName() + " : シード回転");

            CZSystem.log("CZCMSSeedRotation","" + format.format(prof) + " rpm");
            CZSystem.log("CZCMSSeedRotation","" + format.format(reslt) + " rpm");
            CZSystem.log("CZCMSSeedRotation","" + format.format(man) + " rpm");
        }
    }
}
