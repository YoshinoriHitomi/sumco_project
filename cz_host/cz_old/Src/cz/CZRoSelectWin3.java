 ...
 ***********************************************************/
public class CZRoSelectWin3 extends JDialog {
...
// add end 2008.09.16
		...
		String roN = CZTPGFrame.lblRo.getText();
...
// add start 2008.09.16
			CZTPGFrame.pnl1_.clearBtCondition();
			CZTPGFrame.lblRo.setText(ro_sel_Pad[ro_index].getText());
			setVisible(false);
// add end 2008.09.16
		}
	}
