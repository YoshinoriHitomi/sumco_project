...
***********************************************************/
public class CZRoSelectWin2 extends JDialog {
...
// del start 2008.09.16
		...
		select_ro_lab = new JLabel(ro_sel_Pad[0].getText(),JLabel.CENTER);
...
// add start 2008.09.16
			CZTblRcpOutPut.RoNameField.setText(ro_sel_Pad[ro_index].getText());
			setVisible(false);
// add end 2008.09.16
		}
	}
