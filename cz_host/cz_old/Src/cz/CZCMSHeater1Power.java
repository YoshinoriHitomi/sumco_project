 ...
 *
 ***********************************************************/
public class CZCMSHeater1Power extends JDialog {
    ...
    private final int PV_RESULT     = 11;
    private final int PV_PROFAIL    = 56;
    private final int PV_MANNUAL    = 97;
    ...
    public boolean setDefault(){
        CZSystem.log("CZCMSHeater1Power","setDefault()");
    ...
    class SendButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            ...
            setSendStatus();
            CZSystem.log("CZCMSHeater1Power","SendButton ----->[" + send_status + "]");
            if(send_status == 0) return;
            //Send
            CZSystem.CZOperateMainHeater1Power(send_status);
        }
    }
    ...
    class SendUndo implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSHeater1Power","SendSendUndo");
            //Send
            CZSystem.CZOperateUndoMainHeater1Power(send_status);
            setDefault();
        }
    }
    ...
    class ZeroButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSHeater1Power","ZeroSendUndo");
            setDefault();
        }
    }
    ...
    class ProEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            CZSystem.log("CZCMSHeater1Power","Proc Change[" + val + "]");
    ...
    class ResultsEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSHeater1Power","Results Change[" + val + "]");
    ...
    class InstructEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            int val = instruct_slider.getValue();
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSHeater1Power","Instruct Change[" + val + "]");
    ...
    class UpdateThread extends Thread {
        ...
        public void run(){
            ...
            CZSystem.log("CZCMSHeater1Power","UpdateThread START");
        ...
        private void setData(){
            ...
            CZSystem.log("CZCMSHeater1Power","" + format.format(prof) + " Kw");
            CZSystem.log("CZCMSHeater1Power","" + format.format(reslt) + " Kw");
            CZSystem.log("CZCMSHeater1Power","" + format.format(man) + " Kw");
        }
    }
}
