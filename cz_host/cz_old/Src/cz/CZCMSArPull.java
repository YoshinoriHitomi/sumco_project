 ...
 ***********************************************************/
public class CZCMSArPull extends JDialog {
    ...
    private final int   PV_RESULT   = 15;
    private final int   PV_PROFAIL  = 71;
    private final int   PV_MANNUAL  = 101;
    ...
    CZCMSArPull(){
        ...
        man_val = new JLabel("0.00 L/min",JLabel.CENTER);
        ...
        pro_label = new JLabel("0.00 L/min",JLabel.CENTER);
        ...
        pro_slider = new JSlider(JSlider.VERTICAL,0,20000,0);
        ...
        JLabel label = null;
        label = new JLabel(" 200.00", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(20000),label);

        label = new JLabel(" 175.00", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(17500),label);

        label = new JLabel(" 150.00", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(15000),label);

        label = new JLabel(" 125.00", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(12500),label);
        ...
        results_label = new JLabel("0.00 L/min",JLabel.CENTER);
        ...
        instruct_label = new JButton("0.00 L/min");
...
//@@        CZSystem.log("CZCMSArPull","setDefault()");
        instruct_slider.setValue(0);
        return true;
    }

    /*******************************************************
     * ----- 実行ボタンのActionListener
     *******************************************************/
    class SendButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            setSendStatus();
//@@            CZSystem.log("CZCMSArPull","SendButton ----->[" + send_status + "]");
            if(send_status == 0) return;
            //Send
            CZSystem.CZOperatePullArgonFlow(send_status);
        }
    }

    /*******************************************************
     * ----- アンドゥボタンのActionListener
     *******************************************************/
    class SendUndo implements ActionListener {
        public void actionPerformed(ActionEvent ev){
//@@            CZSystem.log("CZCMSArPull","SendSendUndo");
            //Send
            CZSystem.CZOperateUndoPullArgonFlow(send_status);
            setDefault();
        }
    }
    ...
    class ZeroButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
//@@            CZSystem.log("CZCMSArPull","ZeroSendUndo");
            setDefault();
        }
    }
...
//@@            CZSystem.log("CZCMSArPull","Proc Change[" + val + "]");
            pro_label.setText(format.format(data) + " L/min");
        }
    }
    ...
    class ResultsEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            float data = (float)val * TIMES;
//@@            CZSystem.log("CZCMSArPull","Results Change[" + val + "]");
            results_label.setText(format.format(data) + " L/min");
        }
    }
    ...
    class InstructEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            int val = instruct_slider.getValue();
            float data = (float)val * TIMES;
//@@            CZSystem.log("CZCMSArPull","Instruct Change[" + val + "]");
            ...
            instruct_label.setText(format.format(data) + " L/min");
        }
    }
...
//@@            CZSystem.log("CZCMSArPull","UpdateThread START");
...
//@@            CZSystem.log("CZCMSArPull","" + format.format(prof)  + " mm/min");
//@@            CZSystem.log("CZCMSArPull","" + format.format(reslt) + " mm/min");
//@@            CZSystem.log("CZCMSArPull","" + format.format(man)   + " mm/min");
        }
    }
}
