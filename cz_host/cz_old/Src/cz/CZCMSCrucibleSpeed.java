 ...
 *
 ***********************************************************/
public class CZCMSCrucibleSpeed extends JDialog {

    public final float TIMES        = 0.0001f;
    private DecimalFormat format    = new DecimalFormat("0.0000");

    private final int SEND_MAX      =  10000;
    private final int SEND_MIN      = -10000;
    ...
    private final int PV_RESULT     = 19;
    private final int PV_PROFAIL    = 82;
    private final int PV_MANNUAL    = 95;
    ...
    CZCMSCrucibleSpeed(){
        ...
        ////////////////////
        JLabel lab1 = new JLabel("計    算",JLabel.CENTER);
        ...
        pro_slider.setMajorTickSpacing(1000);
        pro_slider.setMinorTickSpacing(100);
        ...
        label = new JLabel(" 0.9000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(9000),label);

        label = new JLabel(" 0.8000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(8000),label);

        label = new JLabel(" 0.7000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(7000),label);

        label = new JLabel(" 0.6000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(6000),label);

        label = new JLabel(" 0.5000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(5000),label);

        label = new JLabel(" 0.4000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(4000),label);

        label = new JLabel(" 0.3000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(3000),label);

        label = new JLabel(" 0.2000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        pro_slider.getLabelTable().put(new Integer(2000),label);

        label = new JLabel(" 0.1000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        ...
        results_slider.setMajorTickSpacing(1000);
        ...
        label = new JLabel(" 0.9000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        results_slider.getLabelTable().put(new Integer(9000),label);

        label = new JLabel(" 0.8000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        results_slider.getLabelTable().put(new Integer(8000),label);

        label = new JLabel(" 0.7000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        results_slider.getLabelTable().put(new Integer(7000),label);

        label = new JLabel(" 0.6000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.black);
        results_slider.getLabelTable().put(new Integer(6000),label);
        ...
        instruct_slider.setMajorTickSpacing(1000);
        instruct_slider.setMinorTickSpacing(200);
        ...
        label = new JLabel(" 0.9000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.red);
        instruct_slider.getLabelTable().put(new Integer(9000),label);

        label = new JLabel(" 0.8000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.red);
        instruct_slider.getLabelTable().put(new Integer(8000),label);

        label = new JLabel(" 0.7000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.red);
        instruct_slider.getLabelTable().put(new Integer(7000),label);

        label = new JLabel(" 0.6000", JLabel.CENTER );  
        label.setForeground(java.awt.Color.red);
        instruct_slider.getLabelTable().put(new Integer(6000),label);
    ...
    public boolean setDefault(){
        CZSystem.log("CZCMSCrucibleSpeed","setDefault()");
    ...
    class SendButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            ...
            setSendStatus();
            CZSystem.log("CZCMSCrucibleSpeed","SendButton ----->[" + send_status + "]");
            if(send_status == 0) return;
            //Send
            CZSystem.CZOperateRutuboUp(send_status);
        }
    }
    ...
    class SendUndo implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSCrucibleSpeed","SendSendUndo");
            //Send
            CZSystem.CZOperateUndoRutuboUp(send_status);
            setDefault();
        }
    }
    ...
    class ZeroButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSCrucibleSpeed","ZeroSendUndo");
            setDefault();
        }
    }
    ...
    class ProEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            CZSystem.log("CZCMSCrucibleSpeed","Proc Change[" + val + "]");
    ...
    class ResultsEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSCrucibleSpeed","Results Change[" + val + "]");
    ...
    class InstructEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            int val = instruct_slider.getValue();
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSCrucibleSpeed","Instruct Change[" + val + "]");
    ...
    class UpdateThread extends Thread {
        ...
        //
         public void run(){
            ...
            CZSystem.log("CZCMSCrucibleSpeed","UpdateThread START");
        ...
        private void setData(){
            ...
            setTitle(s + " : ルツボ速度");
//            setTitle(CZSystem.getRoName() + " : ルツボ速度");

            CZSystem.log("CZCMSCrucibleSpeed","" + format.format(prof) + " mm/min");
            CZSystem.log("CZCMSCrucibleSpeed","" + format.format(reslt) + " mm/min");
            CZSystem.log("CZCMSCrucibleSpeed","" + format.format(man) + " mm/min");
        }
    }
}
