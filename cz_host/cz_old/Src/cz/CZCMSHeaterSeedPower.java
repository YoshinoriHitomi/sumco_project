 ...
 *
 ***********************************************************/
public class CZCMSHeaterSeedPower extends JDialog {
    ...
    private final int PV_RESULT     = 120;
    private final int PV_PROFAIL    = 109;
    ...
    CZCMSHeaterSeedPower(){
        ...
        ////////////////////
        JLabel lab1 = new JLabel("最終操作量",JLabel.CENTER);
    ...
    public boolean setDefault(){
        CZSystem.log("CZCMSHeaterSeedPower","setDefault()");
    ...
    class SendButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            setSendStatus();
            CZSystem.log("CZCMSHeaterSeedPower","SendButton ----->[" + send_status + "]");
            if(send_status == 0) return;
            //Send
            CZSystem.CZOperateSeedHeater(send_status);
        }
    }
    ...
    class SendUndo implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSHeaterSeedPower","SendSendUndo");
            CZSystem.CZOperateUndoSeedHeater(send_status);
            setDefault();
        }
    }
    ...
    class ZeroButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSHeaterSeedPower","ZeroSendUndo");
            setDefault();
        }
    }
    ...
    class ProEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            CZSystem.log("CZCMSHeaterSeedPower","Proc Change[" + val + "]");
    ...
    class ResultsEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSHeaterSeedPower","Results Change[" + val + "]");
    ...
    class InstructEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            int val = instruct_slider.getValue();
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSHeaterSeedPower","Instruct Change[" + val + "]");
    ...
    class UpdateThread extends Thread {
        ...
        public void run(){
            ...
            CZSystem.log("CZCMSHeaterSeedPower","UpdateThread START");
        ...
        private void setData(){
            ...
            CZSystem.log("CZCMSHeaterSeedPower","" + format.format(prof) + " mm/min");
            CZSystem.log("CZCMSHeaterSeedPower","" + format.format(reslt) + " mm/min");
        }
    }
}
