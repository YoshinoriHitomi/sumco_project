 ...
 *
 ***********************************************************/
public class CZCMSCrucibleRotation extends JDialog {

    public final float    TIMES     = 0.001f ;
    ...
    private final int PV_RESULT     = 20;
    private final int PV_PROFAIL    = 86;
    private final int PV_MANNUAL    = 96;

    //
    //
    //
	@SuppressWarnings("unchecked")
    CZCMSCrucibleRotation(){
        super();
        ...
        man_val = new JLabel("0.00 rpm",JLabel.CENTER);
        ...
        pro_label = new JLabel("0.000 rpm",JLabel.CENTER);
        ...
        pro_slider = new JSlider(JSlider.VERTICAL,0,25000,0);
        ...
        results_label = new JLabel("0.000 rpm",JLabel.CENTER);
        ...
        results_slider = new JSlider(JSlider.VERTICAL,0,25000,0);
        ...
        instruct_label = new JButton("0.000 rpm");
...
//@@        CZSystem.log("CZCMSCrucibleRotation","CZCMSSeedRotation setDefault()");
    ...
    class SendButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            ...
            setSendStatus();
//@@            CZSystem.log("CZCMSCrucibleRotation","SendButton ----->[" + send_status + "]");
            if(send_status == 0) return;
            //Send
            CZSystem.CZOperateRutuboRotate(send_status);
        }
    }
    ...
    class SendUndo implements ActionListener {
        public void actionPerformed(ActionEvent ev){
//@@            CZSystem.log("CZCMSCrucibleRotation","SendSendUndo");
            //Send
            CZSystem.CZOperateUndoRutuboRotate(send_status);
            setDefault();
        }
    }
    ...
    class ZeroButton implements ActionListener {
        public void actionPerformed(ActionEvent ev){
            CZSystem.log("CZCMSCrucibleRotation","ZeroSendUndo");
            setDefault();
        }
    }
    ...
    class ProEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            CZSystem.log("CZCMSCrucibleRotation","ProEvent Proc Change[" + val + "]");
            pro_label.setText(format.format(data) + " rpm");
        }
    }
    ...
    class ResultsEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSCrucibleRotation","ResultsEvent Results Change[" + val + "]");
            results_label.setText(format.format(data) + " rpm");
        }
    }
    ...
    class InstructEvent implements ChangeListener {
        public void stateChanged(ChangeEvent ev){
            ...
            int val = instruct_slider.getValue();
            float data = (float)val * TIMES;
            CZSystem.log("CZCMSCrucibleRotation","Instruct Change[" + val + "]");
            ...
            instruct_label.setText(format.format(data) + " rpm");
        }
    }
    ...
    class UpdateThread extends Thread {
        ...
        public void run(){
            ...
            CZSystem.log("CZCMSCrucibleRotation","UpdateThread START");
        ...
        private void setData(){
            ...
            man_val.setText(format.format(man) + " rpm");

            String s = CZSystem.RoKetaChg(CZSystem.getRoName());
            setTitle(s + " : ルツボ回転");
//            setTitle(CZSystem.getRoName() + " : ルツボ回転");
            CZSystem.log("CZCMSCrucibleRotation","" + format.format(prof)  + " rpm");
            CZSystem.log("CZCMSCrucibleRotation","" + format.format(reslt) + " rpm");
            CZSystem.log("CZCMSCrucibleRotation","" + format.format(man)   + " rpm");
        }
    }
}
