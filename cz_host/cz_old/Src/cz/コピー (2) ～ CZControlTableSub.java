...
/*********************************************************************************************************/
    private JButton     testM_button     = null; //保存ボタン
    private JButton     testC_button   = null; //修正ボタン
/*********************************************************************************************************/
...
/********************************************************************************************************/
        testC_button = new JButton("TEST修  正");
        testC_button.setBounds(500, 790, 100, 24);         //@@@
//        modify_button.setBounds(260, 800, 100, 24);
        testC_button.setLocale(new Locale("ja","JP"));
        testC_button.setFont(new java.awt.Font("dialog", 0, 18));
        testC_button.setBorder(new Flush3DBorder());
        testC_button.setForeground(java.awt.Color.black);
        testC_button.addActionListener(new ModifyButton());
        getContentPane().add(testC_button);

//        save_button = new JButton("修正保存");
        testM_button = new JButton("TEST保存");				// 2004.05.27
        testM_button.setBounds(500, 820, 100, 24);           //@@@
//        save_button.setBounds(360, 800, 100, 24);
        testM_button.setLocale(new Locale("ja","JP"));
        testM_button.setFont(new java.awt.Font("dialog", 0, 18));
        testM_button.setBorder(new Flush3DBorder());
        testM_button.setForeground(java.awt.Color.black);
        testM_button.addActionListener(new SaveButton());
        getContentPane().add(testM_button);
/**********************************************************************************************************/
